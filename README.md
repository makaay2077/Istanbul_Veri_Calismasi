...
İBB Veri Setlerinden Sağlık Kurumları Veri Seti ve Nüfus verilerinden yararlanarak ilk olarak KeplerGL kütüphanesini kullanıp , Yataklı Hastane konumlarını noktalar olarak gösterimini yaptım7.Nokta Büyüklükleri yatak sayısıyla orantılı.Ardından veriler üzerinde matematiksel işlemler ile İlçelere göre 1000 kişi başına düşen yatak sayısını bulup plotly kütüphanesi yardımıyla hem yatak  hem de düşey olarak görselleştirdim.


En sonuncuda da Google Earth Engine verileri kullanarak earth engine'da gömülü Makina Öğrenimi algoritmaları ile (Kmeans Kümeleme) arazi örtüsünü 5 sınıfa ayırarak görselleştirmesini yaptım.
