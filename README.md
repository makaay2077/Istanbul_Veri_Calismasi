...
En sonuncuda da Google Earth Engine verileri kullanarak earth engine'da gömülü Makina Öğrenimi algoritmaları ile (Kmeans Kümeleme) arazi örtüsünü 5 sınıfına ayırarak görselleştirmesini yaptım.
